...
const STEPS = [
  ...
  { id: 'avt', label: 'Actual vs Teórico', icon: '📊', system: 'R365', required: false, accept: '.csv', acceptLabel: 'CSV (.csv)', where: 'R365 → Reports → Actual vs Theoretical Analysis', extracts: 'Faltantes y sobrantes de inventario' },
